...
//print 2nd product title/name
console.log(product_Data.products[1].title)
console.log(product_Data.products[1].price)

let {products}  = product_Data;  //Object Destructuring
