...
/*verify car model Thar available or not using
1.find() with nornaml function
        
        let car=cars.find(function(car){
                return car.model==="Thar"
        })

2.find() with fat arrow function

        let car=cars.find((car)=>{
          return car.model ==="Thar";
        })
3.find() with implicit return
*/
let car=cars.find(c=>c.model==="xyz")
